  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="projectTeamDemoApp.employee.home.createOrEditLabel">
            <Translate contentKey="projectTeamDemoApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : employeeEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="firstNameLabel" for="employee-firstName">
                  <Translate contentKey="projectTeamDemoApp.employee.firstName">First Name</Translate>
                </Label>
                <AvField id="employee-firstName" type="text" name="firstName" />
                <UncontrolledTooltip target="firstNameLabel">
                  <Translate contentKey="projectTeamDemoApp.employee.help.firstName" />
                </UncontrolledTooltip>
              </AvGroup>
              <AvGroup>
                <Label id="lastNameLabel" for="employee-lastName">
                  <Translate contentKey="projectTeamDemoApp.employee.lastName">Last Name</Translate>
                </Label>
                <AvField id="employee-lastName" type="text" name="lastName" />
              </AvGroup>
              <AvGroup>
                <Label id="emailLabel" for="employee-email">
                  <Translate contentKey="projectTeamDemoApp.employee.email">Email</Translate>
                </Label>
                <AvField id="employee-email" type="text" name="email" />
              </AvGroup>
              <AvGroup>
                <Label id="phoneNumberLabel" for="employee-phoneNumber">
                  <Translate contentKey="projectTeamDemoApp.employee.phoneNumber">Phone Number</Translate>
                </Label>
                <AvField id="employee-phoneNumber" type="text" name="phoneNumber" />
              </AvGroup>
              <AvGroup>
                <Label id="hireDateLabel" for="employee-hireDate">
                  <Translate contentKey="projectTeamDemoApp.employee.hireDate">Hire Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="salaryLabel" for="employee-salary">
                  <Translate contentKey="projectTeamDemoApp.employee.salary">Salary</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="employee-manager">
                  <Translate contentKey="projectTeamDemoApp.employee.manager">Manager</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="employee-department">
                  <Translate contentKey="projectTeamDemoApp.employee.department">Department</Translate>
                </Label>
