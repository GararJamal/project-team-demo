...
export const EmployeeDeleteDialog = (props: IEmployeeDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="projectTeamDemoApp.employee.delete.question">
        <Translate contentKey="projectTeamDemoApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
