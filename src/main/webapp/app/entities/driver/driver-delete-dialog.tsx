...
export const DriverDeleteDialog = (props: IDriverDeleteDialogProps) => {
  ...
  const confirmDelete = () => {
    props.deleteEntity(props.driverEntity.id);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="projectTeamDemoApp.driver.delete.question">
        <Translate contentKey="projectTeamDemoApp.driver.delete.question" interpolate={{ id: driverEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-driver" color="danger" onClick={confirmDelete}>
