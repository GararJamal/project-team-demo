  ...
  return (
    <div>
      <h2 id="driver-heading">
        <Translate contentKey="projectTeamDemoApp.driver.home.title">Drivers</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="projectTeamDemoApp.driver.home.createLabel">Create new Driver</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('projectTeamDemoApp.driver.home.search')}
                />
        ...
        {driverList && driverList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="projectTeamDemoApp.driver.home.notFound">No Drivers found</Translate>
            </div>
          )
        )}
      </div>
