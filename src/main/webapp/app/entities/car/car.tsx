...
export const Car = (props: ICarProps) => {
  ...
  return (
    <div>
      <h2 id="car-heading">
        <Translate contentKey="projectTeamDemoApp.car.home.title">Cars</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="projectTeamDemoApp.car.home.createLabel">Create new Car</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('projectTeamDemoApp.car.home.search')}
                />
        ...
        {carList && carList.length > 0 ? (
            ...
            <tbody>
              {carList.map((car, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {car.drivers
                      ? car.drivers.map((val, j) => (
                          <span key={j}>
                            <Link to={`driver/${val.id}`}>{val.id}</Link>
                            {j === car.drivers.length - 1 ? '' : ', '}
                          </span>
                        ))
                      : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="projectTeamDemoApp.car.home.notFound">No Cars found</Translate>
            </div>
          )
        )}
      </div>
