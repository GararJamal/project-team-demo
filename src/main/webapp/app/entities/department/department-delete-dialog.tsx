...
export const DepartmentDeleteDialog = (props: IDepartmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="projectTeamDemoApp.department.delete.question">
        <Translate contentKey="projectTeamDemoApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
