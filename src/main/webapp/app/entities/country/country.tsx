  ...
  return (
    <div>
      <h2 id="country-heading">
        <Translate contentKey="projectTeamDemoApp.country.home.title">Countries</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="projectTeamDemoApp.country.home.createLabel">Create new Country</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('projectTeamDemoApp.country.home.search')}
                />
        ...
        {countryList && countryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="projectTeamDemoApp.country.nom">Nom</Translate>
                </th>
                <th>
                  <Translate contentKey="projectTeamDemoApp.country.code">Code</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="projectTeamDemoApp.country.home.notFound">No Countries found</Translate>
            </div>
          )
        )}
      </div>
