...
export const CountryDeleteDialog = (props: ICountryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="projectTeamDemoApp.country.delete.question">
        <Translate contentKey="projectTeamDemoApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
