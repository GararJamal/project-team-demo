...
export const JobHistoryDeleteDialog = (props: IJobHistoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="projectTeamDemoApp.jobHistory.delete.question">
        <Translate contentKey="projectTeamDemoApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
