  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="projectTeamDemoApp.jobHistory.home.createOrEditLabel">
            <Translate contentKey="projectTeamDemoApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="startDateLabel" for="job-history-startDate">
                  <Translate contentKey="projectTeamDemoApp.jobHistory.startDate">Start Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="endDateLabel" for="job-history-endDate">
                  <Translate contentKey="projectTeamDemoApp.jobHistory.endDate">End Date</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label id="languageLabel" for="job-history-language">
                  <Translate contentKey="projectTeamDemoApp.jobHistory.language">Language</Translate>
                </Label>
                <AvInput
                ...
                >
                  <option value="FRENCH">{translate('projectTeamDemoApp.Language.FRENCH')}</option>
                  <option value="ENGLISH">{translate('projectTeamDemoApp.Language.ENGLISH')}</option>
                  <option value="SPANISH">{translate('projectTeamDemoApp.Language.SPANISH')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="job-history-job">
                  <Translate contentKey="projectTeamDemoApp.jobHistory.job">Job</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="job-history-department">
                  <Translate contentKey="projectTeamDemoApp.jobHistory.department">Department</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="job-history-employee">
                  <Translate contentKey="projectTeamDemoApp.jobHistory.employee">Employee</Translate>
                </Label>
