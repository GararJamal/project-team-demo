...
import static ma.projectteam.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
...
import ma.projectteam.myapp.config.audit.AuditEventConverter;
import ma.projectteam.myapp.domain.PersistentAuditEvent;
