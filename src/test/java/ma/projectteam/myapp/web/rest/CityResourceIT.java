...
import ma.projectteam.myapp.repository.CityRepository;
import ma.projectteam.myapp.repository.search.CitySearchRepository;
import ma.projectteam.myapp.service.CityService;
...
public class CityResourceIT {
     ...
     *
     * @see ma.projectteam.myapp.repository.search.CitySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void updateCity() throws Exception {
        ...
        // Validate the City in Elasticsearch
        verify(mockCitySearchRepository, times(2)).save(testCity);
    }
