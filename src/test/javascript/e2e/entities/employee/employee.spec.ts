...
describe('Employee e2e test', () => {
  ...
  it('should load create Employee page', async () => {
    ...
    expect(await employeeUpdatePage.getPageTitle().getAttribute('id')).to.match(/projectTeamDemoApp.employee.home.createOrEditLabel/);
  ...
  it('should delete last Employee', async () => {
    ...
    expect(await employeeDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/projectTeamDemoApp.employee.delete.question/);
